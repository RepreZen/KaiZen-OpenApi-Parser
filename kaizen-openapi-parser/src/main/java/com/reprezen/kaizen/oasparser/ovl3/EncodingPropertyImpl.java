...
public class EncodingPropertyImpl extends OpenApiObjectImpl<EncodingProperty>
	...
	@Generated("com.reprezen.kaizen.oasparser.jsonoverlay.gen.CodeGenerator")
	private ValMapOverlay<String, StringOverlay> headers = new ValMapOverlay<String, StringOverlay>("Headers", this,
			StringOverlay.factory, null);
	...
	public static JsonOverlayFactory<EncodingPropertyImpl> factory = new JsonOverlayFactory<EncodingPropertyImpl>() {
		...
		public EncodingPropertyImpl create(String key, JsonNode json, JsonOverlay<?> parent) {
			return isEmptyRecursive(parent, EncodingPropertyImpl.class) ? null
					: new EncodingPropertyImpl(key, json, parent);
		}
	};
