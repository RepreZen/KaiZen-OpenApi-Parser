...
public class SecurityParameterImpl extends OpenApiObjectImpl<SecurityParameter>
	...
	@Generated("com.reprezen.kaizen.oasparser.jsonoverlay.gen.CodeGenerator")
	private ValListOverlay<String, StringOverlay> parameters = new ValListOverlay<String, StringOverlay>("", this,
	...
	public static JsonOverlayFactory<SecurityParameterImpl> factory = new JsonOverlayFactory<SecurityParameterImpl>() {
		...
		public SecurityParameterImpl create(String key, JsonNode json, JsonOverlay<?> parent) {
			return isEmptyRecursive(parent, SecurityParameterImpl.class) ? null
					: new SecurityParameterImpl(key, json, parent);
		}
	};
