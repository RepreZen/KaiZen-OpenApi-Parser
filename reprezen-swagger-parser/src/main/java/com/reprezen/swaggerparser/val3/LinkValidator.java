...
public class LinkValidator extends ObjectValidatorBase<Link> {
    ...
    private Operation findOperationById(Swagger3 model, String operationId) {
    ...
    private Operation findOperationByPath(Swagger3 model, String relativePath, ValidationResults results) {
